...
frappe.provide("approved_accounting.approved_accounting");
{% include 'erpnext/public/js/controllers/buying.js' %};

approved_accounting.approved_accounting.ApprovedPurchaseInvoice = erpnext.buying.BuyingController.extend({
	setup: function(doc) {
...
cur_frm.script_manager.make(approved_accounting.approved_accounting.ApprovedPurchaseInvoice);
...
frappe.ui.form.on('Approved Purchase Invoice', {
	setup: function(frm) {
